#!/usr/bin/env python
"""S61 WiSE-FT: interpolate the CPT checkpoint 0.5/0.5 with stock Moirai 2.0.

theta = 0.5 * stock + 0.5 * CPT -- the same procedure as make_wiseft_s60.py.
The result is the "m2-retrofit" (arm_W50.pt).
"""
import argparse
import json
import os
...
OUT = os.path.join(HERE, "s61_wiseft.json")
...
def main():
    ...
    ap.add_argument("--suffix", default="",
                    help="seed-replication suffix (e.g. _s20260902): read "
                         ...
                         "s61_wiseft{suffix}.json; default '' = seed-20260901")
    args = ap.parse_args()
    sfx = args.suffix
